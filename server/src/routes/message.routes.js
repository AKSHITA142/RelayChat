...
const { getMessagesByChat, deleteMessageForMe, deleteMessageForEveryone, restoreMessageForMe, uploadFile, reactToMessage, syncDeviceHistoryKeys, clearChat } = require("../controllers/message.controller");
const upload = require("../middleware/upload.middleware");

router.get("/:chatId", auth, getMessagesByChat);
router.post("/upload", auth, upload.single("file"), uploadFile);
router.post("/sync-device-history", auth, syncDeviceHistoryKeys);
