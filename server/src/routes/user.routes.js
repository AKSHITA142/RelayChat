...
const { getProfile, updateProfile, updateAvatar, searchUsers, checkPhoneNumber, saveContact, getUserEncryptionKey, upsertEncryptionKey, saveBackupKey, getBackupKey, verifyMobileForKeyReset } = require("../controllers/user.controller");
