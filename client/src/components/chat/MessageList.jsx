    ...
    return (
      <div className="flex flex-1 items-center justify-center px-6 py-10">
        <motion.div
          ...
          className="surface-panel grid max-w-4xl gap-4 p-6 text-center md:grid-cols-3"
        >
          {[
            ...
            <div key={item.title} className="surface-inline rounded-[24px] p-5">
              <div className="mb-4 inline-flex rounded-2xl border border-white/10 bg-white/6 p-3">{item.icon}</div>
